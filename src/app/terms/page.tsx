            ...
            <div className="space-y-8 text-sm sm:text-base">
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  By accessing and using Xpto (&quot;the Service&quot;), you accept and agree to be
                  bound by the terms and provisions of this agreement. If you do not agree to abide
                  by these terms, please do not use this service. These terms constitute a legally
                  binding agreement between you and Wild Rose IT Consulting Inc., the company
                  operating the Xpto service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed mb-3">
                  Permission is granted to use Xpto for personal, non-commercial use. This is the
                ...
                <ul className="list-disc list-inside space-y-2 text-foreground/90 pl-2">
                  ...
                  <li>
                    Transfer the materials to another person or mirror the Service on another server
                  </li>
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  The materials on Xpto are provided on an &apos;as is&apos; basis. Wild Rose IT
                  Consulting Inc. makes no warranties, expressed or implied, and hereby disclaims
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  In no event shall Wild Rose IT Consulting Inc. or its suppliers be liable for any
                  ...
                  on Xpto, even if we or our authorized representative has been notified orally or
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  The materials appearing on Xpto could include technical, typographical, or
                  photographic errors. Wild Rose IT Consulting Inc. does not warrant that any of the
                  materials on the Service are accurate, complete, or current. We may make changes
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  Wild Rose IT Consulting Inc. has not reviewed all of the sites linked to its
                  website and is not responsible for the contents of any such linked site. The
                  inclusion of any link does not imply endorsement by Wild Rose IT Consulting Inc.
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  Wild Rose IT Consulting Inc. may revise these terms of service for the Service at
                  any time without notice. By using this Service, you are agreeing to be bound by
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  ...
                  laws of the jurisdiction in which Wild Rose IT Consulting Inc. operates, and you
                ...
                <div className="space-y-4 text-foreground/90">
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 pl-2">
                      <li>
                        Available within <strong>7 days</strong> of purchase for any reason
                      </li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 pl-2">
                      ...
                      <li>
                        <strong>Takes 5-10 business days</strong> to appear in customer account
                      </li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 pl-2">
                      <li>
                        If you initiate a chargeback or dispute with your payment processor, we will
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 pl-2">
                      <li>
                        <strong>Service outage:</strong> Automatic credit issued for affected period
                      </li>
                      <li>
                        <strong>Billing error:</strong> Immediate refund plus credit for future
                        usage
                      </li>
                      <li>
                        <strong>Upgrade/downgrade:</strong> Prorated credit applied to next billing
                        cycle
                      </li>
                    </ul>
                  </div>
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  To the fullest extent permitted by law, Wild Rose IT Consulting Inc. shall not be
                  liable for any indirect, incidental, special, consequential, or punitive damages,
                  even if Wild Rose IT Consulting Inc. has been advised of the possibility of such
                  damages. Your sole remedy is limited to the amount paid to Wild Rose IT Consulting
                  Inc.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-foreground/90 leading-relaxed">
                  ...
                  Consulting Inc. will notify affected users and relevant authorities within the
                  timeframes required by applicable law (including Canadian PIPEDA regulations). We
                  maintain comprehensive incident response procedures to protect your data.
                </p>
              </section>
            </div>
          </div>
