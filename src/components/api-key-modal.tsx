      ...
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-lg mx-4">
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-6">
            {viewingKey
              ? 'View the details of this API key.'
              : editingKey
          ...
          <form onSubmit={viewingKey ? (e) => e.preventDefault() : onSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-2">
                Key Name <span className="text-red-500">*</span> — A unique name to identify this
                key
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-3">
                Key Type <span className="text-red-500">*</span> — Choose the environment for this
                key
              </label>
              <div className="space-y-3">
                ...
                <div
                  ...
                  onClick={
                    viewingKey ? undefined : () => onFormDataChange({ keyType: 'development' })
                  }
                >
                ...
                <div
                  ...
                  onClick={
                    viewingKey ? undefined : () => onFormDataChange({ keyType: 'production' })
                  }
                >
                  <div className="flex items-center space-x-3">
                    <div
            ...
            <div>
              <label className="block text-sm font-medium text-black mb-3">
                Permissions <span className="text-red-500">*</span> — Select the permissions for
                this API key
              </label>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Select the permissions this API key should have. Admin permission includes all other
                permissions.
              </p>
            </div>
            ...
            <div>
              ...
              {formData.limitUsage && (
                <input
                  ...
                  onChange={(e) =>
                    onFormDataChange({ monthlyLimit: parseInt(e.target.value) || 0 })
                  }
            ...
            {!viewingKey && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-sm text-blue-800">
                  <span className="text-red-500">*</span> Required fields: Key Name, Key Type, and
